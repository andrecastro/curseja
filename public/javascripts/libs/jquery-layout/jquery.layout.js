    ...
    $.fn.layout = function (opts) {
        ...
        var cssNum = function ($E, prop) {
            ...
            if (!$.browser.msie) { // IE CAN read dimensions of 'hidden' elements - FF CANNOT
                if ($($E[0]).css("display", true) == "none") {
                    hidden = true;
                    visibility = $($E[0]).css("visibility", true); // SAVE current setting
                    $E.css({ display: "block", visibility: "hidden" }); // show element 'invisibly' so we can measure it
                }
            }

            val = parseInt($($E[0]).css(prop, true), 10) || 0;
        ...
        var cssW = function (e, outerWidth) {
            ...
            if (!$.boxModel)
                ...
                return outerWidth
                    ...
                    - ($($E[0]).css("borderLeftStyle", true) == "none" ? 0 : cssNum($E, "borderLeftWidth"))
                    - ($($E[0]).css("borderRightStyle", true) == "none" ? 0 : cssNum($E, "borderRightWidth"))
                    ;
        };
        var cssH = function (e, outerHeight) {
            ...
            if (!$.boxModel)
                ...
                return outerHeight
                    ...
                    - ($($E[0]).css("borderTopStyle", true) == "none" ? 0 : cssNum($E, "borderTopWidth"))
                    - ($($E[0]).css( "borderBottomStyle", true) == "none" ? 0 : cssNum($E, "borderBottomWidth"))
                    ;
        };
